...
* *sample_diagram.png*: an example diagram to demonstrate how to include an image in the report.

## Instructions:

Modify the \titlepage{} tag to include your team number and the current year (yes, we reuse this template every year).